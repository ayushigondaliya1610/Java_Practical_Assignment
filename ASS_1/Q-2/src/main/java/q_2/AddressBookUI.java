...
public class AddressBookUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("HomeAddress");

        jLabel3.setText("BusAddress");

        jLabel4.setText("HomePhone");

        jLabel5.setText("BusPhone");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Name", "HomeAddress", "HomePhone", "BusAddress", "BusPhone", "Fax", "Cell", "Pager"
            }
        ));
        jScrollPane1.setViewportView(jTable1);

        jLabel10.setText("Search what u want:");
...
java.util.ArrayList<Address> list = new java.util.ArrayList<>();
javax.swing.table.DefaultTableModel model;
    ...
    public void updateTable() {
        model.setRowCount(0);
        for (Address a : list) {
            Object[] row = {a.name, a.homeAddress, a.homePhone, a.busAddress, a.busPhone, a.fax, a.cell, a.pager};
            model.addRow(row);
        }
    }
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {
        ...
        jTextField9.setText(model.getValueAt(selectedRow, 7).toString()); 
    }
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (row != -1) {
            ...
            list.set(row, updatedAddr);
            updateTable();
            clearFields();
            JOptionPane.showMessageDialog(this, "Update SuccessFully Done");
       } else {
    ...
    if (row != -1) {
        ...
        updateTable();    
        clearFields();
        JOptionPane.showMessageDialog(this, "Delete SuccessFully Done");
    } else {
        JOptionPane.showMessageDialog(this, "Select the row");
    }
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        String searchName = jTextField10.getText().trim(); 

    if (searchName.isEmpty()) {
        JOptionPane.showMessageDialog(this, "કૃપા કરીને શોધવા માટે નામ લખો!");
        return;
    }

    boolean found = false;
    for (int i = 0; i < list.size(); i++) {
        if (list.get(i).name.equalsIgnoreCase(searchName)) {
            jTable1.setRowSelectionInterval(i, i);
            
            Address a = list.get(i);
            jTextField1.setText(a.name);
            jTextField2.setText(a.homeAddress);
            jTextField3.setText(a.homePhone);
            jTextField4.setText(a.busAddress);
            jTextField5.setText(a.busPhone);
            jTextField7.setText(a.fax);
            jTextField8.setText(a.cell);
            jTextField9.setText(a.pager);
